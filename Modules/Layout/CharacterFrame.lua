...
function Layout:LayoutCharacterFrame()
    ...
    _G.PaperDollFrame.CharacterStatsPane = Layout:CreateCharacterStatsPane()
    --_G.PaperDollFrame.CharacterTabs = Layout:CreateCharacterTabs()

    -- adjust frame width
    Layout:SecureHook("CharacterFrame_ShowSubFrame", function()
    ...
    Layout:SecureHook("ToggleCharacter", function()
        if _G.PaperDollFrame:IsShown() then
    ...
    if _G.CharacterGuildText then
        ...
        Layout:SecureHook("PaperDollFrame_SetLevel", function()
        ...
        Layout:SecureHook("PaperDollFrame_SetGuild", function()
    ...
    Layout:RegisterEvent("PLAYER_EQUIPMENT_CHANGED", Layout.UpdateCharacterStatsPane)
    _G.CharacterFrame:HookScript("OnShow", Layout.UpdateCharacterStatsPane)
end

function Layout:CreateCharacterTabs()
    local size = 35
    local spacing = 5
...
function Layout:CreateCharacterStatsPane()
    ...
    frame.ItemLevel = Layout:CreateCharacterStatsPane_ItemLevel(frame)
    frame.Attributes = Layout:CreateCharacterStatsPane_Attributes(frame)
    frame.Enhancements = Layout:CreateCharacterStatsPane_Enhancements(frame)

    return frame
end

function Layout:CreateCharacterStatsPane_ItemLevel(parent)
...
function Layout:CreateCharacterStatsPane_Attributes(parent)
    ...
    Layout:HandleStat(stat1, frame, false, {"TOPLEFT", frame.Header, "BOTTOMLEFT", 0, 0},
                     {"TOPRIGHT", frame.Header, "BOTTOMRIGHT", 0, 0})
    Layout:HandleStat(stat2, frame, true, {"TOPLEFT", stat1, "BOTTOMLEFT", 0, 0}, {"TOPRIGHT", stat1, "BOTTOMRIGHT", 0, 0})
    Layout:HandleStat(stat3, frame, false, {"TOPLEFT", stat2, "BOTTOMLEFT", 0, 0}, {"TOPRIGHT", stat2, "BOTTOMRIGHT", 0, 0})
    Layout:HandleStat(stat4, frame, true, {"TOPLEFT", stat3, "BOTTOMLEFT", 0, 0}, {"TOPRIGHT", stat3, "BOTTOMRIGHT", 0, 0})
    Layout:HandleStat(stat5, frame, false, {"TOPLEFT", stat4, "BOTTOMLEFT", 0, 0}, {"TOPRIGHT", stat4, "BOTTOMRIGHT", 0, 0})
    Layout:HandleStat(stat6, frame, true, {"TOPLEFT", stat5, "BOTTOMLEFT", 0, 0}, {"TOPRIGHT", stat5, "BOTTOMRIGHT", 0, 0})

    return frame
end

function Layout:CreateCharacterStatsPane_Enhancements(parent)
...
function Layout:HandleStat(stat, parent, showBackground, point1, point2)
    ...
    if showBackground then
        Layout:CreateStatBackground(stat)
    end
end

function Layout:CreateStatBackground(entry)
...
function Layout:UpdateCharacterStatsPane()
    if not _G.CharacterFrame:IsShown() then
        return
    end

    Layout:UpdateAverageItemLevel()
...
function Layout:UpdateAverageItemLevel()
