            ...
            layout = {
                ...
                args = {
                    ...
                    tooltips = {
                        ...
                        inline = true,
                        args = {
                            enabled = Addon:CreateToggleOption(L["Enabled"], nil, 1, nil, {"layout", "tooltips", "enabled"}),
                            lineBreak = {type = "header", name = "", order = 2},
                            showIcons = Addon:CreateToggleOption(L["Show Icons"], nil, 10, "full",
                                                                 {"layout", "tooltips", "showIcons"}),
                            showItemCount = Addon:CreateToggleOption(L["Show Item Count"], nil, 11, "full",
                                                                     {"layout", "tooltips", "showItemCount"}),
                            showVendorPrice = Addon:CreateToggleOption(L["Show Vendor Price"], nil, 12, "full",
                                                                       {"layout", "tooltips", "showVendorPrice"}),
                            showItemLevel = Addon:CreateToggleOption(L["Show Item Level"], nil, 13, "full",
                                                                     {"layout", "tooltips", "showItemLevel"})
                        }
                    }
                }
            },
            styling = {
                ...
                args = {
                    borders = {
                        ...
                        name = L["Borders"],
                        args = {
                            enabled = Addon:CreateToggleOption(L["Enabled"], nil, 1, nil, {"styling", "borders", "enabled"}),
                            lineBreak = {type = "header", name = "", order = 2},
                    ...
                    shadows = {
                        ...
                        name = L["Shadows"],
                        args = {
                            enabled = Addon:CreateToggleOption(L["Enabled"], nil, 1, nil, {"styling", "shadows", "enabled"}),
                            lineBreak = {type = "header", name = "", order = 2},
                            color = Addon:CreateColorOption(L["Shadow Color"], 10, {"styling", "shadows", "color"}),
                            size = Addon:CreateRangeOption(L["Shadow Size"], nil, 11, 3, 30, 1, {"styling", "shadows", "size"}),
                            shadowPerButton = Addon:CreateToggleOption(L["Shadow Per Button"], nil, 12, nil,
                                                                       {"styling", "shadows", "shadowPerButton"})
                        }
                    }
                }
            },
...
function Addon:CreateBorderStyleOption(caption, order, configKey)
    local setting = {"styling", "borders", configKey}
    return {
        order = order,
        type = "select",
        name = caption,
